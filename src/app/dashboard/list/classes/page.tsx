...
const ClassListPage = async ({
  ...
  const response = await fetch(`${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/api/classes`, {
    headers: {
      'Content-Type': 'application/json',
    },
  })
  const { data: classesData, count: classesCount } = await response.json()
